  ...
  <section class="blogs-news-container">
    <div class="grid-container blogs-main-new">
      ...
      try {
          ...
          $sql = "SELECT id, titulo, tipo, contenido FROM posts ORDER BY id DESC LIMIT 1";
          ...
          if ($latest_post) {
              ...
              if (strpos($latest_post['contenido'], 'youtube.com/watch?v=') !== false) {
                  $video_id = explode("v=", $latest_post['contenido'])[1];
                  ...
                  echo "<img src='assets/img/" . htmlspecialchars($latest_post['contenido']) . "' alt='Imagen del post' class='card-img-large'>";
              }
          ...
          $cards_per_page = 8;  // Mostrar cuatro tarjetas pequeñas en una fila
          ...
          $sql = "SELECT id, titulo, tipo, contenido FROM posts WHERE id != " . $latest_post['id'] . " ORDER BY id DESC LIMIT $cards_per_page OFFSET $offset";
          $stmt = $conexion->query($sql);
          ...
          while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
              ...
              // Verifica si es un enlace de YouTube
              if (strpos($row['contenido'], 'youtube.com/watch?v=') !== false) {
                  $video_id = explode("v=", $row['contenido'])[1];
                  ...
                  echo "<img src='assets/img/" . htmlspecialchars($row['contenido']) . "' alt='Imagen del post' class='card-img'>";
              }
